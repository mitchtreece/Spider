...
internal class EventStreamParser {
    ...
    //  \r = CR (Carriage Return) → Used as a new line character in macOS < 10
    //  \n = LF (Line Feed) → Used as a new line character in Unix / macOS >= 10
    ...
    func append(data: Data) -> [Event] {
        ...
        return eventsFromBuffer()
        
    }
    
    private func eventsFromBuffer() -> [Event] {
